...
public class PWNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    static HashMap< String, Class> classNames = new HashMap< String, Class>();
    public static String TAG="easyWSDL";
    static {
        classNames.put("http://schemas.datacontract.org/2004/07/ClientCabinet_MicroService^^LastLoginDetail",PWNLastLoginDetail.class);
        classNames.put("http://schemas.datacontract.org/2004/07/ClientCabinet_MicroService^^ArrayOfLastLoginDetail",PWNArrayOfLastLoginDetail.class);
    } 
    ...
    public static void setDateTimeConverter(PWNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PWNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PWNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PWNDateTimeConverter dateTimeConverter = new PWNStandardDateTimeConverter();

    public PWNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PWNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PWNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!= String.class  )) {
                String xmlName=PWNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(PWNExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PWNExtendedSoapSerializationEnvelope.class);
    ...
    public static Object getXSDType(Object param)
    {
        ...
        String xmlName=PWNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
